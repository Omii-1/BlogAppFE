...
const Nav = () => {
  ...
  return(
    <>
      ...
      <NavLink to="/profile" className="hover:underline underline-offset-4 text-white text-xl font-semibold">Profile</NavLink>
  ...
  return(
    <div className="sticky backdrop-blur-md top-0 z-[20] mx-auto flex flex-wrap w-full items-center justify-between p-4 px-8">
      <div className="flex gap-5 items-center">
        ...
        <NavLink to="/" className="font-extrabold text-2xl text-white">Blogify</NavLink>
      </div>
